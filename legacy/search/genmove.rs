...
use crate::legacy_search::alphabeta::SearchConfig;
use crate::legacy_search::deprecated::mcts::MctsConfig;

pub use crate::legacy_search::deprecated::mcts::DEFAULT_MAX_SIMULATIONS as MCTS_DEFAULT_MAX_SIMULATIONS;
pub use crate::legacy_search::deprecated::mcts::DEFAULT_UCT as MCTS_DEFAULT_UCT;
pub use crate::legacy_search::pipeline::{
...
pub fn genmove_algebraic(board: &mut Board, config: GenmoveConfig) -> Option<String> {
    crate::legacy_search::pipeline::select_move(board, config)
}
