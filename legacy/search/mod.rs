//! Legacy αβ search — historical CLI / pipeline, not Titanium play search.
//!
//! Production play search lives in `crate::titanium::search`. LMR helpers used by
//! both stacks live there (`v16_lmr`, `cat_index_lmr`).
