...
impl BenchInstr {
    ...
    pub fn to_json(&self) -> String {
        ...
        let ops: [(&str, &OpStat); 57] = [
            ...
            ("wall_path_trial", &self.wall_path_trial),
            ...
            ("wall_flood_exact", &self.wall_flood_exact),
            ("wall_witness_cut", &self.wall_witness_cut),
