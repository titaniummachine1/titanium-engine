...
use crate::titanium::{algebraic_to_move_id, move_id_to_algebraic, GameState, TitaniumSearch};
        ...
        match parts[0] {
            ...
            "go" => {
                ...
                let (time_ms, sched) = if parts.get(1).map(|s| *s) == Some("rem") {
                    ...
                    let ja = crate::titanium::race::jump_aware_goal_distances(&mut search.g);
                    ...
                    let budget = crate::titanium::time_alloc::allocate_move_budget_with_dists(
                        remaining_ms,
                        search.g.hist_len,
                        search.g.turn,
                        search.g.pawn,
                ...
                #[cfg(not(target_arch = "wasm32"))]
                {
                    ...
                    let root_score_text = crate::titanium::search::score_label(result.score);
                    let t = result.timing;
                    let (
                        sched_move_ms,
                        sched_optimum_ms,
                ...
                if result.mv == crate::titanium::TITANIUM_NO_MOVE {
