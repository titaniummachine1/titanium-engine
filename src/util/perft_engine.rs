//! Perft driver.
//!
//! Relocated out of the legacy search tree. It never contained a search: every
//! method delegates to `util::perft`, and it only adds a node-cache and a
//! thread pool. Keeping it meant the legacy engine could be deleted without
